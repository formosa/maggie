...
class ConfigManager:
    ...
    def validate(self) -> None:
        ...
        self._validate_fsm_config()
        self._validate_hardware_specific_settings()
    ...
    def _extract_hardware_specific_settings(self, config):
        hardware_settings = {}
        return hardware_settings

    def _restore_hardware_specific_settings(self, settings):
        pass

    def _deep_merge(self, default_dict, user_dict):
        return default_dict

    def _find_latest_backup(self):
        return None

    def _create_backup(self, reason):
        pass